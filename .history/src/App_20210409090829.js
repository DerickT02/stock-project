...
return (
   <div className = "App" style = {{'backgroundImage':`url("https://g.foolcdn.com/editorial/images/620816/stock-up-glowing-green-arrow-climbs-on-a-stock-screen.jpg")`, 'width':'100%'}}>
   {user ? (
       <GlobalProvider>
       <BrowserRouter>
           <Switch>
